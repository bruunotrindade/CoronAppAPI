# Generated by Django 3.0.2 on 2020-03-27 00:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=60, verbose_name='Nome')),
                ('type_symptom', models.CharField(max_length=1, verbose_name='Tipo de Sintoma')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='appuser',
            name='symptoms',
            field=models.ManyToManyField(through='base.UserSymptoms', to='base.Symptom', verbose_name='Sintomas'),
        ),
    ]
